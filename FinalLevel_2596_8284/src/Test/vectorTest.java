...
// this part of program is in the Test package, this is the tests of Vector.
//it defines the tests of Vector-testAdd(),testSubstract(),testScaling(),testDotProduct(),testLength(),testNormalize(),
//testCrossProduct().
package Test;
import Primitives.*;
