...
public class RenderTest {
	@Test
	public void basicRendering() throws Exception{//4 triangles and sphere
		//try{
	...
	@Test
	public void basicRendering1() throws Exception{//ice-cream
		//try{
		Scene scene = new Scene();
		Sphere s=new Sphere(50, new Point3D(new Coordinate(-50), new Coordinate(0.0),new Coordinate( -150)));
		s.setEmission(Color.WHITE);
		scene.addGeometry(s);
		Sphere s1=new Sphere(50, new Point3D(new Coordinate(50), new Coordinate(0.0),new Coordinate( -150)));
		s1.setEmission(Color.WHITE);
		scene.addGeometry(s1);
	    Sphere s2=new Sphere(50, new Point3D(new Coordinate(0.0), new Coordinate(70),new Coordinate( -150)));
		s2.setEmission(Color.WHITE);
		scene.addGeometry(s2);
		Triangle triangle = new Triangle(new Point3D( new Coordinate(-80),new Coordinate(10),new Coordinate(-150)),
				 						 new Point3D( new Coordinate(80),new Coordinate (10),new Coordinate(-150)),
				 						 new Point3D(new Coordinate (0),new Coordinate (-200),new Coordinate( -150)));
		triangle.setEmission(Color.WHITE);
		scene.addGeometry(triangle);
		...
		@Test
		public void basicRendering2() throws Exception{//heart
			//try{
			Scene scene = new Scene();
			Sphere s1=new Sphere(48, new Point3D(new Coordinate(-48), new Coordinate(0.0),new Coordinate( -150)));
			s1.setEmission(Color.WHITE);
			scene.addGeometry(s1);
			Sphere s2=new Sphere(48, new Point3D(new Coordinate(48), new Coordinate(0.0),new Coordinate( -150)));
			s2.setEmission(Color.WHITE);
			scene.addGeometry(s2);
			Triangle triangle = new Triangle(new Point3D( new Coordinate(-108),new Coordinate(-9),new Coordinate(-150)),
					 						 new Point3D( new Coordinate(108),new Coordinate (-9),new Coordinate(-150)),
					 						 new Point3D(new Coordinate (0),new Coordinate (-150),new Coordinate( -150)));
			triangle.setEmission(Color.WHITE);
			scene.addGeometry(triangle);
		...
		@Test
		public void basicRendering3() throws Exception{//4 triangle and sphere-emmision check
			//try{
			Scene scene = new Scene();
		...
		@Test 
		public void emmissionTest() throws Exception{//another emmission test
