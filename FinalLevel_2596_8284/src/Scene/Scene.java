...
//this part of program is in the Scene package, this is the class of Scene.
//it defines a Scene , by name, background color,list of geometry that in the scene,
//camera and the distance between the P0 to the view plane.
